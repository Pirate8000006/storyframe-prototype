...
export default function NewProjectPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--color-canvas)]">
      <TopNavBar />
      <main className="flex-1 px-[48px] py-[64px] max-w-[1200px] w-full mx-auto">
        <h1 className="text-[32px] font-bold text-[var(--color-ink)]">Create a new project</h1>
        <p className="text-[15px] text-[var(--color-muted)] mt-[12px] max-w-[600px]">
        ...
        <form onSubmit={handleSubmit} className="mt-[48px]">
          ...
          <div className="mt-[48px] pt-[32px] border-t border-[var(--color-hairline)] flex justify-end">
            <Button type="submit" variant="primary" className="cursor-pointer shadow-sm">
              Create Project →
            </Button>
          </div>
        </form>
