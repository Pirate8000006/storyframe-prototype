...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    company: "TransitPay",
    stage: "Deck",
    updatedLabel: "Deck · updated 2d ago",
    description: "Redesigning the cross-border transfer flow to increase trust.",
    meshGradient: "radial-gradient(at 0% 0%, #e0e7ff 0px, transparent 50%), radial-gradient(at 100% 0%, #c7d2fe 0px, transparent 50%), radial-gradient(at 100% 100%, #a5b4fc 0px, transparent 50%), radial-gradient(at 0% 100%, #e0e7ff 0px, transparent 50%)",
  },
  {
    ...
    stage: "Evidence",
    updatedLabel: "Evidence · updated 5d ago",
    description: "Reducing friction in the first 5 minutes of usage.",
    meshGradient: "radial-gradient(at 0% 0%, #ffedd5 0px, transparent 50%), radial-gradient(at 100% 0%, #fed7aa 0px, transparent 50%), radial-gradient(at 100% 100%, #fdba74 0px, transparent 50%), radial-gradient(at 0% 100%, #ffedd5 0px, transparent 50%)",
  },
  {
    id: "design-system-v2",
    ...
    company: "Internal",
    stage: "Sources",
    updatedLabel: "Sources · updated 1w ago",
    description: "Consolidating component libraries into a unified token system.",
    meshGradient: "radial-gradient(at 0% 0%, #d1fae5 0px, transparent 50%), radial-gradient(at 100% 0%, #a7f3d0 0px, transparent 50%), radial-gradient(at 100% 100%, #6ee7b7 0px, transparent 50%), radial-gradient(at 0% 100%, #d1fae5 0px, transparent 50%)",
  },
];
